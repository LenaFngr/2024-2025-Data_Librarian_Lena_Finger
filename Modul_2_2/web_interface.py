# infos zu streamlit: https://docs.streamlit.io/
...
INDEX_PATH = os.getcwd() + "/df_unternehmen_index_mult/data.properties"
DATA_PATH =  os.getcwd() + "/df_unternehmen_index_mult/publications.pkl"
